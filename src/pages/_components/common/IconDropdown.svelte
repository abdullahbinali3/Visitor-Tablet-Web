...
<div
  class="ml-3 relative inline-block text-left {containerClass}"
  bind:this={elem}>
  <div>
    <button
      ...
      type="button"
      class="-my-2 p-2 rounded-full bg-white flex items-center text-gray-400
      hover:text-gray-600 focus:outline-none focus:ring-2 focus:ring-sky-500"
      id={name}
      aria-expanded={open}
      aria-haspopup="true">
